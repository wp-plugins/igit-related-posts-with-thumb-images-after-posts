...
function igit_show_rel_post()
{
   ...
   // $igit_search_str = addslashes($post->post_title . ' ' . $post->post_content);
    ...
    if ($igit_rpwt['igit_credit'] == "1")
        $output .= '<div style="font-size: 8px; float: left;width:100%;" ><a style="color:#D2D2D2" href="http://www.hackingethics.com/"  title="PHP Freelancer , PHP Freelancer India , Hire PHP Freelancer" title="PHP Freelancer , PHP Freelancer India , Hire PHP Freelancer">PHP Freelancer India</a></div>';
    return $output;
}
